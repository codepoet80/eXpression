...
<body onload="initMenu()">
	...
	<td valign="top" class="content">
		...
		<xsl:if test="//eXpression/@siteimage != ''">
			<xsl:if test="//request/@page != 'expression.htm' and //request/@page != 'expression-servers.htm'">
				<div align="center"><img border="0" style="cursor:pointer;" onclick="document.location='http://www.jonandnic.com'">
		...
		<xsl:choose>
			<xsl:when test="//eXpression/dsBlog">
				...
				<h5>
					<a href="http://www.jonandnic.com">Jonathan Wise</a>, 2002-2005<br/><A href="http://creativecommons.org/licenses/by-nc/1.0/">Some Rights Reserved</A>
				</h5>
				</td>
				</tr></table>
			</xsl:when>
	...
	<td valign="top" style="width:160px;" class="menu">
		...
		<br/>&amp;nbsp;<br/>
		<a target="_blank" href="http://www.jonandnic.com.net">
			<img alt="Powered by eXpression" border="0">
				<xsl:attribute name="src">
					http://www.jonandnic.com/expression/images/expression.gif?siteid=<xsl:value-of select="//request/@blogID"/>
				</xsl:attribute>
			</img>
		</a>
