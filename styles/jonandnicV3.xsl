...
<style type="text/css">
	...
	Body		{margin-top:10px; margin-left:10px;font-family:Arial, Helvetica; font-size: 9pt;
				background: #ACB0BF url(http://www.jonandnic.com/expression/site_1/images/blue-gradient.gif);background-repeat: repeat-x; background-attachment: fixed; background-position: left bottom;}
