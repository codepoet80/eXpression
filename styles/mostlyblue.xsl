...
<style>
	.SiteTitleCell	{ line-height:1.2em;
				color:#ccc;
				letter-spacing:.2em; background-color:#226699;
				border: 8px solid #fff;}
	.StarTitleCell	{ line-height:1.2em;
				color:#ccc;
				letter-spacing:.2em; background-color:#CCDDF7;
	...
	.PostHeaderDate	{
		...
		text-transform: uppercase;
		color: #0D3C60; font-weight:bold;
		}
	.PostFooter	{font-size:11px;margin-top: 8px; border-bottom: 3px solid #9BB2CA; padding-bottom: 20px;margin-bottom:20px;color:#0D3C60;}
	...
	.main		{margin:12px 15px 10px 10px; padding:16px; border: 8px solid #fff;background-color:#C1D3DC;}
	Body		{
				margin: 0;
				padding: 0;
				text-align: center;
	...
	a		{
			text-decoration:none; color: #226699;
			font-weight: bold;
			}
