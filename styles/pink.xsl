...
<style>
	.SiteTitleCell	{ line-height:1.2em;
				color:#ccc;
				letter-spacing:.2em; background-color:#761c37;}
	.SiteTitle {margin: 0;
	...
	.PostHeaderDate	{
		...
		text-transform: uppercase;
		color: #ba476b; font-weight:bold;
		}
	.PostFooter	{font-size:11px;margin-top: 8px; border-bottom: 3px solid #fedfe6; padding-bottom: 20px; margin-bottom:20px;color:#ba476b;}

	.menu		{width: 170px; padding: 15px; color: #761c37; background-color:#fedfe6;	}
	.menuBlock	{ border-bottom: 1px dotted white; }
	.main		{margin:12px 15px 10px 10px; padding:16px; border: 1px solid #000;background-color:#FDEEF2;}
	Body		{
				margin: 0;
				padding: 0;
				text-align: center;
				min-width: 760px;
				background: #ce436e url(http://www.jonandnic.com/expression/site_6/images/snowflakes.gif) repeat left top;
				font-family: helvetica, arial, verdana, "trebuchet ms", sans-serif;
				color: #632035;
				}
	TD		{font-family:arial,helvetica; font-size: 9pt;}
	a		{
			text-decoration:none; color: #bf277e;
			font-weight: bold;
			}

	a:hover {
			color: #96095a; text-decoration:underline;
			}
	...
	.psThumb:hover	
				{
				border: 1px solid #96095a; 
				}
</style>
<!--http://www.blogblog.com/thisaway_rose/bg_body.gif-->
<script>
...
<body>
		...
		<xsl:choose>
			<xsl:when test="//eXpression/dsBlog">
				...
				<xsl:for-each select="//blogData">
					<table style="clear:left" border='0' cellpadding='0' cellspacing='0'><tr><td><span class="PostHeader"><xsl:value-of select="EntryTitle"/></span> - <span class="PostHeaderDate"><xsl:value-of select="EntryDay"/></span></td></tr></table>
					&amp;nbsp;<br/>
	...
	<td valign="top" style="" class="menu">
		<b>Content</b>
		<div class="menuBlock">
